...
class PianoView {
	...
	addHoverEventListeners() {
		...
		pianoView.addEventListener("mouseover", this.mouseOverFunction);
		...
		pianoView.addEventListener("mousemove", this.mouseMoveFunction);
		...
		pianoView.addEventListener("mouseout", this.mouseOutFunction);
	}
