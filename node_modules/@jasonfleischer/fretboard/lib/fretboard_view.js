...
class FretboardView {
	...
	addHoverEventListeners() {
		...
		view.removeEventListener("mouseover", mouseOverFunction(self));
		view.addEventListener("mouseover", mouseOverFunction(self));


		view.removeEventListener("mousemove", mouseMoveFunction(self));
		view.addEventListener("mousemove", mouseMoveFunction(self));

		view.removeEventListener("mouseout", mouseOutFunction(self));
		view.addEventListener("mouseout", mouseOutFunction(self));
	}
