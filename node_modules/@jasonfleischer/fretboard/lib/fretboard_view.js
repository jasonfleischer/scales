...
class FretboardView {
	...
	addHoverEventListeners() {
		...
		if(this.mouseOverFunction !== undefined)
			view.removeEventListener("mouseover", this.mouseOverFunction, true);
		...
		view.addEventListener("mouseover", this.mouseOverFunction, true);
		
		if(this.mouseMoveFunction !== undefined)
			view.removeEventListener("mousemove", this.mouseMoveFunction, true);
		...
		view.addEventListener("mousemove", this.mouseMoveFunction, true);
		...
		if(this.mouseOutFunction !== undefined)
			view.removeEventListener("mouseout", this.mouseOutFunction, true);
		...
		view.addEventListener("mouseout", this.mouseOutFunction, true);
	}
