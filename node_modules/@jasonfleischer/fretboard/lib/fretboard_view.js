...
class FretboardView {
	...
	addHoverEventListeners() {
		...
		view.removeEventListener("mouseover", mouseOverFunction, true);
		view.addEventListener("mouseover", mouseOverFunction(self), true);


		view.removeEventListener("mousemove", mouseMoveFunction, true);
		view.addEventListener("mousemove", mouseMoveFunction(self), true);

		view.removeEventListener("mouseout", mouseOutFunction, true);
