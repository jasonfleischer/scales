...
class FretboardView {
	...
	addHoverEventListeners() {
		...
		var mouseOverFunction = function(self) {
		...
		const mouseMoveFunction = function(self){
			return function curried_func(event) {
		...
		view.removeEventListener("mouseover", mouseOverFunction(self), true);
		view.addEventListener("mouseover", mouseOverFunction(self), true);


		view.removeEventListener("mousemove", mouseMoveFunction(self), true);
		view.addEventListener("mousemove", mouseMoveFunction(self), true);

		view.removeEventListener("mouseout", mouseOutFunction(self), true);
		view.addEventListener("mouseout", mouseOutFunction(self), true);
	}
